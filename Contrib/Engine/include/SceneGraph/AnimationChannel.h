...
public:
	typedef boost::shared_ptr<AnimationChannel> HardPtr;
	
	typedef boost::weak_ptr<AnimationChannel> WeakPtr;
	...
	virtual void OnAnimate(SceneNode::HardPtr node, float dt) = 0;
