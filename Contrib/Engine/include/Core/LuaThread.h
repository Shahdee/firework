...
public:
	...
	bool isFinished() { return _finished && !hasChildren(); }
...
LuaThread::HardPtr RunLuaThread(luabind::object func, luabind::object table);

inline LuaThread::HardPtr RunLuaThread(const std::string& func, luabind::object table = luabind::object())
{
	return RunLuaThread(luabind::globals(Core::luaStateMain)[func], table);
}

inline LuaThread::HardPtr RunLuaThread(luabind::object func)
{
	return RunLuaThread(func, luabind::object());
}
